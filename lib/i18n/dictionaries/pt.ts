...
export const pt = {
  ...
  funnel: {
    ...
    staffWorking: 'Atendem neste dia',
    staffLittleTime: 'Pouco tempo',
    staffAway: 'Não atendem neste dia',
    staffAwayOff: 'que não está em {loja}',
    staffAwayOffMany: 'que não estão em {loja}',
    staffAwayFull: 'que já tem a agenda cheia',
    staffAwayFullMany: 'que já têm a agenda cheia',
    stepCount: '{n} de {total}',
